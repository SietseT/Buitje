...
<template>
  <div class="relative h-full w-full">
    <RadarMap
      ...
      @geolocate-error="handleGeolocateError"
    />
    ...
    <div
      v-if="locationHintVisible"
      class="absolute top-4 right-4 z-10 max-w-[calc(100vw-2rem)] sm:max-w-xs"
    >
      <div
    ...
    <div
      v-if="placingMarker"
      class="absolute top-4 left-1/2 z-10 -translate-x-1/2 px-4"
    >
      <div
